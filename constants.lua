...
local ATLAS_NAMES = {
  ...
  QUEST_LOG_TASK_ICON = "UI-QuestPoi-QuestNumber",
  QUEST_LOG_TASK_ICON_HIGHLIGHT = "UI-QuestPoi-InnerGlow",
  SHINY_ICON = "rare-elite-star",
  SOURCE_ACHIEVEMENT = "UI-HUD-MicroMenu-Achievements-Mouseover",
  SOURCE_DISCOVERY = "loreobject-32x32",
  SOURCE_DROP = "worldquest-icon-boss",
